...
arch = [
    ...
    to_ConvConvRelu( name='ccr1', s_filer=500, n_filer=(16,16), y="136", offset="(0,0,0)", to="(0,0,0)", width=(4,4), height=48, depth=48),
    to_Pool(name="pool1", offset="(0,0,0)", to="(ccr1-east)", width=1, height=40, depth=40, opacity=0.5),
    
    to_ConvConvRelu( name='ccr2', s_filer=500, n_filer=(32,32), offset="(4,0,0)", to="(pool1-east)", width=(4,4), height=32, depth=32  ),
    ...
    to_SoftMax("soft1", 32256, offset="(2,0,0)", to="(pool3-east)", depth=24),
    to_connection("pool3", "soft1"),
    
    to_SoftMax("soft2", 8192, offset="(4,0,0)", to="(pool3-east)", depth=20),
    to_connection("soft1", "soft2"),

    to_SoftMax("soft3", 1024, offset="(6,0,0)", to="(pool3-east)", depth=16),
    to_connection("soft2", "soft3"),
    
    to_SoftMax("soft4", 6, offset="(8,0,0)", to="(pool3-east)", depth=12),
